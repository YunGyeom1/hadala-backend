...
class Company(Base):
    ...
    # retailer_company_detail_id = Column(UUID(as_uuid=True), ForeignKey("retailer_company_details.company_id"), nullable=True)
    # farm_company_detail_id = Column(UUID(as_uuid=True), ForeignKey("farm_company_details.company_id"), nullable=True)
