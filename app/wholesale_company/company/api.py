...
from app.wholesale_company.company import crud, schemas
from app.wholesale_company.company.utils import check_company_permission
from app.database import get_db
from app.users.user.models import User
from app.users.user.api import get_current_user
from app.users.wholesaler.crud import get_wholesaler_by_user_id
from app.users.wholesaler.schemas import WholesalerOut
from app.wholesale_company.center.schemas import CenterOut
...
def create_company(
    ...
    """
    # 도매상 권한 체크
    wholesaler = get_wholesaler_by_user_id(db, current_user.id)
...
@router.get("/{company_id}/wholesalers", response_model=List[WholesalerOut])
