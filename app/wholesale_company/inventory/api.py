...
from app.wholesale_company.inventory import crud, schemas
from app.users.user.models import User
from app.wholesale_company.management.schemas import DailySettlement
...
@router.post("/settlements/today", response_model=DailySettlement)
...
@router.post("/settlements/today/center/{center_id}", response_model=DailySettlement)
